...
public class WorkspaceMother : ObjectMother
{
    ...
    internal static Workspace WithOwner(string ownerId)
    {
        return new Workspace(
            RandomWorkspaceId(),
            new WorkspaceOwnerId(ownerId),
    ...
    {
        return new Workspace(new WorkspaceId(v), RandomWorkspaceOwnerId(), RandomWorkspaceName());
    }

    internal static Workspace Random()
    {
        return new Workspace(RandomWorkspaceId(), RandomWorkspaceOwnerId(), RandomWorkspaceName());
    }
}
